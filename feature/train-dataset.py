...
MAX_SENTENCES     = 1_000        # None = use all. Cap train sentences before split.
...
EPOCHS             = 200
BATCH_SIZE         = 256
EMBED_BATCH        = 128     # harrier is larger — smaller batch
...
for epoch in range(1, EPOCHS + 1):
    ...
    for start in range(0, N, BATCH_SIZE):
        ...
        mod_a, mod_b = sample_contrastive_pairs(CONTRASTIVE_PAIRS)
